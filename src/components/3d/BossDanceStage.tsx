  ...
  return (
    <div className="relative w-full min-h-[100dvh] bg-gradient-to-b from-[#1c0617] via-[#10030e] to-[#090108] text-white flex flex-col justify-center items-center p-0 select-none overflow-x-hidden text-center">
      ...
      <div
        ...
        className="fixed inset-y-0 left-0 w-1/2 bg-gradient-to-r from-[#2a041c] via-[#1a0212] to-black border-r-2 border-amber-400 z-50 pointer-events-none will-change-transform shadow-[10px_0_40px_rgba(0,0,0,0.8)]"
      />
      <div
        style={{
          transform: curtainsOpen ? 'translateX(105%)' : 'translateX(0%)',
        ...
        className="fixed inset-y-0 right-0 w-1/2 bg-gradient-to-l from-[#2a041c] via-[#1a0212] to-black border-l-2 border-amber-400 z-50 pointer-events-none will-change-transform shadow-[-10px_0_40px_rgba(0,0,0,0.8)]"
      />
